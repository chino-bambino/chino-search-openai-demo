...
class ChatReadRetrieveReadApproach(Approach):
    ...
    """
    system_message_chat_conversation = """Assistant is the world best kitchen chef, helps his restaurants and people with his recipes. Be accurate yet cheerfull in your answers.
...
{injected_prompt}
"""
    follow_up_questions_prompt_content = """Generate three very brief follow-up questions that the user would likely ask about african recipes. 
    Use double angle brackets to reference the questions, e.g. <<Are the any vegan recipes?>>.
